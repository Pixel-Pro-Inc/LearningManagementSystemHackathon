...
const routes: Routes = [
  ...
  },
  {
    path: 'excel',
    loadChildren: () =>
      import('./_modules/excel/excel.module').then((x) => x.ExcelModule),
  },
  {
    path: 'word',
    loadChildren: () =>
      import('./_modules/doc/doc.module').then((x) => x.DocModule),
  },
  {
    path: 'pdf',
    loadChildren: () =>
      import('./_modules/pdf/pdf.module').then((x) => x.PdfModule),
  },
